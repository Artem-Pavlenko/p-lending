  ...
  return (
    <div className="article_wrapper">
      ...
      <Text type={TextStyles.ArticleText}>
        ...
        Our Privacy Policy was created with the help of thePrivacy Policy
        Generator
      </Text>

      <ArticleHeading text="Consent" />
      <Text type={TextStyles.ArticleText}>
      ...
      <ArticleHeading text="How we use your information" />
      ...
      <ArticleHeading text="CCPA Privacy Rights (Do Not Sell My Personal Information)" />
      <span className="list_title">
      ...
      <ArticleHeading text="GDPR Data Protection Rights" />
      <span className="list_title">
